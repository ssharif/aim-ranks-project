...
\begin{proposition}
  Let $\scd$ be the model constructed in section \S~\ref{sec:blow-up-Q} with special fiber described in \S~\ref{sec:dual-graph}. Then
  \begin{enumerate}
...
\begin{proof}
  This is a simple application of Prop.~\ref{prop:transverse-self-intersections}.
\end{proof}
