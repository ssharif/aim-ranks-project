...
\begin{align*}
  D_{P_{00}} \cdot P_{00} &= \bigg(-\frac{d-1}{d} - \frac{1}{rd}\bigg) + \bigg(-\frac{d-1}{d} \cdot \frac{r+d-1}{r}\bigg) + \bigg(\frac{r-1}{r}\bigg) \\
  &= ???.
\end{align*}
Therefore
\begin{align*}
...
We have
\begin{align*}
  D_{P_{00}} \cdot P_{i0} &= \bigg(-\frac{d-1}{d} - \frac{1}{rd}\bigg) + \bigg(-\frac{d-1}{d} \cdot \frac{r+d-1}{r}\bigg) + 0 \\
  &= ???.
\end{align*}
...
Here
\begin{align*}
  D_{P_{00}} \cdot P_{0j} &= -\frac{1}{rd} - \frac{1}{rd} + \frac{r-1}{r} \\
  &= ???.
\end{align*}

\subsubsection{$i\neq 0$, $j \neq 0$, $i + j \equiv 0 \pmod{r}$}
\label{sec:i-neq-0-j-neq-0-equiv}

In this case, we get
\begin{align*}
  D_{P_{00}} \cdot P_{ij} &= -\frac{1}{rd} + \bigg(-\frac{d-1}{d} \cdot \frac{r+d-1}{r}\bigg) \\
  &= ???.
\end{align*}

\subsubsection{$i \neq 0$, $j \neq 0$, $i+j \not\equiv 0 \pmod{r}$}
\label{sec:i-neq-0-j-neq-0-not-equiv}

In the last case, we have
\begin{align*}
  D_{P_{00}} \cdot P_{ij} &= -\frac{1}{rd} - \frac{1}{rd}.
\end{align*}
