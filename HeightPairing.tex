...
\begin{proof}
  ...
  \]
  where $U = \frac{1}{u}$. This glues to $\sX_1$ via 
  \[
  (x, y) = (u^d x_\infty, u^{d/r} y_\infty).
  \]
\end{proof}
\end{document}
