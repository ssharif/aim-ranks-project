...
Put the components of $C_k$ in the order $D_1, D_2, \dots, D_{s-1}, E_{s-1}, \dots, E_1, F$. With respect to this ordering, the intersection matrix is

\subsection{Case 2: $r$ even}
\label{sec:case-2:-r}

Put the components of $C_k$ in the order $D_1, D_2, \dots, D_{s-1}, G_s, E_{s-1}, \dots, E_1, F$. With respect to this ordering, the intersection matrix is the $2s \times 2s$ matrix
\[
