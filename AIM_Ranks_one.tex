...
\]
This model is birational to the original model, $y^r = x^{r-1}(x+1)(x+t)$, via $\sy = y/x$, $x_0 = x + 1$, and $t_0 = t - 1$. The model is generically smooth away from infinity, and has a cusp at infinity which can be desingularized by normalization. 
