...
For $P_{00}$, $x-u$ furnishes a nonzero global section for the corresponding conormal sheaf. One checks that this section is regular and nonvanishing on the locus of good reduction. We now compute the zeros and poles of $x-u$ place by place.
