...
\usepackage{amssymb,amsmath,mathrsfs,amsthm,amscd,booktabs,hyperref,amsfonts,graphicx}
\usepackage[all]{xy}
...
We now compute the self-intersections of $P_{00}$ and $Q_\infty$.
\begin{proposition}\label{prop:Q-infty-self-intersection}
  ...
  \]
\end{proposition}
The computations will proceed as follows. Let $P$ be the point in question. We may identify $P$ with the corresponding morphism $\PP \to \XX$. Let $\II$ be the ideal sheaf of $P$, considered as a divisor on $\XX$. Recall that the conormal sheaf to $P$ is the sheaf $\II/\II^2$ on $\PP$. By~\cite[V, 1.4.1]{hartshorne}, $P^2 = - \deg \II/\II^2$. Thus our method will be to compute the divisor of a global section of this sheaf. Since sections of $\II$ are rational functions on $\XX$, we will frequently refer to elements of $\II/\II^2$ by choosing a rational function contained in the corresponding mod $\II^2$ congruence class.

\begin{proof}
  Let $\II$ be the ideal sheaf for $Q_\infty$. Then $w$ furnishes a nonzero global section of $\II$, where $w$ is the function given in the chart $\XX_2$. One checks that $w$ is a regular, nonvanishing section of $\II/\II^2$ away from $u = \infty$, since $\XX_2$ is smooth in a neighborhood of $Q_\infty$ when $u \neq \infty$. At $u = \infty$, we consider the chart
  \[
  z' = w'^{r-1}(w'+z'U^d)(w'+z')
  \]
  which glues to $\XX_2$ via $z = U^{d/r} z'$ and $w = U^{d/r} w'$. The point $Q_\infty$ has coordinates $(w', z') = (0,0)$. Notice that $w'$ gives a regular, nonvanishing section of $\II/\II^2$ at $u = \infty$. Since $w = U^{d/r} w'$, we see that as a section of $\II/\II^2$, $\dvsr w = \frac{d}{r}(\infty)$. We conclude that $Q_\infty^2 = -\frac{d}{r}$.
...
\[
(1 + u)^{d-2} \bar{x} + (r-2)u(1+u)^{d-3} \bar{x} + u(1+u)^{d - \frac{d}{r} -1} \bar{b} \equiv \alpha \frac{\bar{x}}{1+u} \pmod{\II^2}.
\]
...
\[
\deg \frac{\II}{\II^2} = a_0 + a_\infty + b_{d/2} = d - \frac{d}{r}.
\]
